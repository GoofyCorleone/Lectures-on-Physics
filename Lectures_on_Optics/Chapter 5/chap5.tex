\section{A historical context of diffraction theory: from shadows to the vector world}
	...
	principle with the principle of interference, creating the \textbf{HuygensFresnel
	...
	the very centre of its shadow (the \textbf{PoissonArago spot}). When Dominique Arago
	...
	\begin{equation}
		U(P) = \frac{1}{i\lambda} \iint_{\text{aperture}} U_0 \frac{e^{ikr}}{r} \cos\theta \, dS \quad \text{(RayleighSommerfeld diffraction)}.
	\end{equation}
